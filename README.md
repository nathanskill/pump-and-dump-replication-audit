...
- **Formal results (frozen protocol, commit `23089ce`)**: three evaluation families on the identical 326-common-event universe — pooled OOF AP 0.9649/0.9462/0.9025 (S0 row-level), 0.9636/0.9466/0.9007 (S1 event-exclusive), 0.9781/0.9572/0.9072 (S2 forward @80%, 25S/15S/5S); event-level EDR and delay under the frozen specification; time-of-day ablation lowers forward AP by 0.010–0.027. See `artifacts/formal_*`.
